...
const values = [
  ...
  {
    title: "전문성",
    desc: "채권추심 전문인력이 고객의 고객의 상황에 맞는 최적의 채무상환 방법을 찾아드립니다.",
  },
  {
    title: "신속성",
    desc: "채무상환 계획이 확정되면, 법적조치 해제, 신용불이익 조치 해제 등을 최대한 신속하게 처리합니다. ",
  },
];
...
export default function CompanyPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      {/* 슬로건 */}
      <p className="text-xl text-gray-700 font-medium mb-12 leading-relaxed border-l-4 border-gray-900 pl-4">
        신뢰와 전문성을 바탕으로 고객에게 최선을 다하겠습니다.
      </p>
